...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_korissa_yksi_ostos_jonka_lukumaara_kaksi_ja_sama_nimi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_kahdesta_samasta_tuotteesta_toisen_poistaminen_jattaa_jaljelle_ostoksen_jolla_maara_yksi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_ainoan_tuotteen_poistaminen_tyhjentaa_korin(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.poista_tuote(self.maito)
        self.assertEqual(self.kori.tavaroita_korissa(), 0)
        self.assertEqual(self.kori.hinta(), 0)
